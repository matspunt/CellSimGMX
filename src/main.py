...
TissueConstruction.replicate_sheared_cell_layer('CELL.xyz', 64, 40, shearing=0.5) #shearing factor additional
...
GMX.convert_xyz_to_gro("CELL_64_sheared.xyz", "CELL_64_sheared.gro", edge_offset=0)
