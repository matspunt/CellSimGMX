...
"""
    Currently (29/05), there are some redundant calls to the parser classes. Let's monitor how much that slows down the execution, if this is insignificant
...
#Note for Mats: to package this as a Python package, see: https://packaging.python.org/en/latest/tutorials/packaging-projects/
